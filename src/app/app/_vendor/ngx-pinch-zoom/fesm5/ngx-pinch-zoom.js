...
var PinchZoomComponent = /** @class */ (function () {
     ...
     */
    function () {
        return this.element.getElementsByTagName(this.zoomContent)[0].offsetHeight;
    };
    /**
     * @return {?}
     */
     ...
     */
    function () {
        return this.element.getElementsByTagName(this.zoomContent)[0].offsetWidth;
    };
    /**
     * @return {?}
     */
    ...
    PinchZoomComponent.propDecorators = {
        ...
        zoomContent: [{ type: Input, args: ['zoom-content',] }],
        events: [{ type: Output }],
